...
f_list=c(FisherC,AFpC,BJ,HC,AFzC,HM,CauchyC,minPC,TFsoftC,CauchyC2,Cauchy,Stouffer,CauchyCtr,TFhardC)
names(f_list)=c("Fisher","AFp","BJ","HC","AFz","HM","CauchyC","minP","TFsoft","CauchyC2","Cauchy","Stouffer","CauchyCtr","TFhardC")
B=10^6
